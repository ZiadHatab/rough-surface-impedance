...
if __name__ == '__main__':
    ...
    # Nickel: sigma = 14.5e6 S/m; mur = 20 (Ansys lists 600, a static value; at GHz nickel's effective permeability is far lower)
    ...
    material_properties_gold = [{'sigma': 41.1e6, 'mur': 0.99996}]      # gold
